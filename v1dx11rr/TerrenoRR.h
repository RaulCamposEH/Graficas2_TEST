...
private:
	...
	wchar_t* texname = L"terrenot.png";
	wchar_t* CespedTex = L"Assets/Terreno/CespedTex.png";
	wchar_t* TierraTex = L"Assets/Terreno/DirtTex.jpg";
...
public:
	...
	bool CargaParametros(WCHAR* diffuseTex, WCHAR* heightTex, float tile)
	{
		...
		int cuenta = anchoTexTerr * altoTexTerr * 3;
		...
		d3dResult = D3DX11CreateShaderResourceViewFromFile( d3dDevice, TierraTex, 0, 0, &colorMap2, 0 );
		d3dResult = D3DX11CreateShaderResourceViewFromFile( d3dDevice, PiedraTex, 0, 0, &colorMap3, 0 );
		...
		//la de proyeccion
		D3DXMatrixPerspectiveFovLH( &projMatrix, D3DX_PI/4.0, ancho / alto, 0.01f, 2000.0f );
